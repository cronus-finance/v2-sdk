...
var _FACTORY_ADDRESSES, _INIT_CODE_HASHES;
var SupportedChainId;

(function (SupportedChainId) {
  SupportedChainId[SupportedChainId["MAINNET"] = 9001] = "MAINNET";
  SupportedChainId[SupportedChainId["EVMOS_TESTNET"] = 9000] = "EVMOS_TESTNET";
  SupportedChainId[SupportedChainId["RINKEBY"] = 4] = "RINKEBY";
})(SupportedChainId || (SupportedChainId = {}));

var FACTORY_ADDRESS = '0x20570b7bFf86B2f92068622D0805160f318554Be';
var FACTORY_ADDRESSES = (_FACTORY_ADDRESSES = {}, _FACTORY_ADDRESSES[SupportedChainId.MAINNET] = '0x20570b7bFf86B2f92068622D0805160f318554Be', _FACTORY_ADDRESSES[SupportedChainId.EVMOS_TESTNET] = '0x3Dc30d756A1382BF454dD6bDb48b7225CA214bB3', _FACTORY_ADDRESSES[SupportedChainId.RINKEBY] = '0x96a7c17FE97AB9F2f96399Ab15544C187B23b110', _FACTORY_ADDRESSES);
var INIT_CODE_HASH = '0xc2c769f6cbfb568ac8562fb6e250ca27d65a3c02c8276593bd86244d6d5c6001';
var INIT_CODE_HASHES = (_INIT_CODE_HASHES = {}, _INIT_CODE_HASHES[SupportedChainId.MAINNET] = '0xc2c769f6cbfb568ac8562fb6e250ca27d65a3c02c8276593bd86244d6d5c6001', _INIT_CODE_HASHES[SupportedChainId.EVMOS_TESTNET] = '0xea9645804ac90dfacad95722451893fc85c951fe30990c9c577bb1b636522211', _INIT_CODE_HASHES[SupportedChainId.RINKEBY] = '0xea9645804ac90dfacad95722451893fc85c951fe30990c9c577bb1b636522211', _INIT_CODE_HASHES);
...
var computePairAddress = function computePairAddress(_ref) {
  ...
  return address.getCreate2Address(factoryAddress, solidity.keccak256(['bytes'], [solidity.pack(['address', 'address'], [token0.address, token1.address])]), (_INIT_CODE_HASHES$tok = INIT_CODE_HASHES[tokenA.chainId]) != null ? _INIT_CODE_HASHES$tok : INIT_CODE_HASH);
};
var Pair = /*#__PURE__*/function () {
  function Pair(currencyAmountA, tokenAmountB) {
    ...
    this.liquidityToken = new sdkCore.Token(tokenAmounts[0].currency.chainId, Pair.getAddress(tokenAmounts[0].currency, tokenAmounts[1].currency), 18, 'CLP', 'Cronus LP');
    this.tokenAmounts = tokenAmounts;
  }

  Pair.getAddress = function getAddress(tokenA, tokenB) {
    var _FACTORY_ADDRESSES$to;

    return computePairAddress({
      factoryAddress: (_FACTORY_ADDRESSES$to = FACTORY_ADDRESSES[tokenA.chainId]) != null ? _FACTORY_ADDRESSES$to : FACTORY_ADDRESS,
      tokenA: tokenA,
      tokenB: tokenB
    });
  }
