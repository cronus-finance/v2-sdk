...
var b = 'setPrototypeOf' in Object,
  ...
  E = (function() {
    ...
    t.getAddress = function(t, e) {
      return O({ factoryAddress: '0x20570b7bFf86B2f92068622D0805160f318554Be', tokenA: t, tokenB: e })
    }
    var o = t.prototype
    return (
      ...
      (o.getOutputAmount = function(o) {
        ...
        var u = this.reserveOf(o.currency),
          ...
          p = e.add(e.multiply(u.quotient, f), s),
          m = n.CurrencyAmount.fromRawAmount(o.currency.equals(this.token0) ? this.token1 : this.token0, e.divide(c, p))
        if (e.equal(m.quotient, a)) throw new I()
        return [m, new t(u.add(o), i.subtract(m))]
      }),
      ...
      (o.getLiquidityValue = function(t, o, u, i, s) {
        ...
        if (
          ...
          if (e.equal(l, a)) c = o
            ...
            var f = n.sqrt(e.multiply(this.reserve0.quotient, this.reserve1.quotient)),
              m = n.sqrt(l)
            if (e.greaterThan(f, m)) {
              var h = e.multiply(o.quotient, e.subtract(f, m)),
                d = e.add(e.multiply(f, p), m),
                y = e.divide(h, d)
      ...
      for (var y = c.wrapped, v = u.wrapped, T = 0; T < e.length; T++) {
        ...
        if (
          ...
          if (q.currency.equals(v))
            n.sortedInsert(p, new t(new P([].concat(s, [A]), o.currency, u), o, n.TradeType.EXACT_INPUT), m, C)
          else if (d > 1 && e.length > 1) {
            var k = e.slice(0, T).concat(e.slice(T + 1, e.length))
            t.bestTradeExactIn(k, o, u, { maxNumResults: m, maxHops: d - 1 }, [].concat(s, [A]), q, p)
          }
        }
      }
      return p
    ...
    (t.bestTradeExactOut = function(e, o, u, i, s, c, p) {
      ...
      for (var y = c.wrapped, v = o.wrapped, T = 0; T < e.length; T++) {
        ...
        if (
          ...
          if (q.currency.equals(v))
            n.sortedInsert(p, new t(new P([A].concat(s), o, u.currency), u, n.TradeType.EXACT_OUTPUT), m, C)
          else if (d > 1 && e.length > 1) {
            var k = e.slice(0, T).concat(e.slice(T + 1, e.length))
            t.bestTradeExactOut(k, o, u, { maxNumResults: m, maxHops: d - 1 }, [A].concat(s), q, p)
          }
        }
      }
      return p
...
;(exports.FACTORY_ADDRESS = '0x20570b7bFf86B2f92068622D0805160f318554Be'),
  ...
  (exports.inputOutputComparator = _),
