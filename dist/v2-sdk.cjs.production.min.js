...
var e = t(require('jsbi')),
  ...
  i = '0xea9645804ac90dfacad95722451893fc85c951fe30990c9c577bb1b636522211',
  s = e.BigInt(1e3),
  a = e.BigInt(0),
  c = e.BigInt(1),
  p = e.BigInt(5),
...
function q(t) {
  ...
  return (q = function(t) {
    ...
    function n() {
      return A(t, arguments, y(this).constructor)
    }
    return (
...
var b = 'setPrototypeOf' in Object,
  x = (function(t) {
    function e() {
      var n
      return (
        ...
        b && Object.setPrototypeOf(k(n), (this instanceof e ? this.constructor : void 0).prototype),
        n
      )
    }
    return d(e, t), e
  ...
  E = (function() {
    ...
    t.getAddress = function(t, e) {
      return O({ factoryAddress: '0x3Dc30d756A1382BF454dD6bDb48b7225CA214bB3', tokenA: t, tokenB: e })
    }
    var o = t.prototype
    return (
      ...
      (o.getOutputAmount = function(o) {
        if (
          ...
          e.equal(this.reserve0.quotient, a) || e.equal(this.reserve1.quotient, a))
        )
          throw new x()
        var u = this.reserveOf(o.currency),
          i = this.reserveOf(o.currency.equals(this.token0) ? this.token1 : this.token0),
          s = e.multiply(o.quotient, l),
          c = e.multiply(s, i.quotient),
          p = e.add(e.multiply(u.quotient, m), s),
          h = n.CurrencyAmount.fromRawAmount(o.currency.equals(this.token0) ? this.token1 : this.token0, e.divide(c, p))
        if (e.equal(h.quotient, a)) throw new I()
        return [h, new t(u.add(o), i.subtract(h))]
      }),
      (o.getInputAmount = function(o) {
        if (
          (this.involvesToken(o.currency) || r(!1),
          e.equal(this.reserve0.quotient, a) ||
            e.equal(this.reserve1.quotient, a) ||
            e.greaterThanOrEqual(o.quotient, this.reserveOf(o.currency).quotient))
        )
          throw new x()
        var u = this.reserveOf(o.currency),
          i = this.reserveOf(o.currency.equals(this.token0) ? this.token1 : this.token0),
          s = e.multiply(e.multiply(i.quotient, o.quotient), m),
          p = e.multiply(e.subtract(u.quotient, o.quotient), l),
          h = n.CurrencyAmount.fromRawAmount(
            o.currency.equals(this.token0) ? this.token1 : this.token0,
            e.add(e.divide(s, p), c)
          )
        return [h, new t(i.add(h), u.subtract(o))]
      }),
      (o.getLiquidityMinted = function(t, o, u) {
        t.currency.equals(this.liquidityToken) || r(!1)
        var i,
          c = o.currency.sortsBefore(u.currency) ? [o, u] : [u, o]
        if (((c[0].currency.equals(this.token0) && c[1].currency.equals(this.token1)) || r(!1), e.equal(t.quotient, a)))
          i = e.subtract(n.sqrt(e.multiply(c[0].quotient, c[1].quotient)), s)
        else {
          ...
          i = e.lessThanOrEqual(p, l) ? p : l
        }
        if (!e.greaterThan(i, a)) throw new I()
        return n.CurrencyAmount.fromRawAmount(this.liquidityToken, i)
      }),
      (o.getLiquidityValue = function(t, o, u, i, s) {
        var c
        if (
          (void 0 === i && (i = !1),
          ...
          if (e.equal(l, a)) c = o
            ...
            var m = n.sqrt(e.multiply(this.reserve0.quotient, this.reserve1.quotient)),
              h = n.sqrt(l)
            if (e.greaterThan(m, h)) {
              var f = e.multiply(o.quotient, e.subtract(m, h)),
                d = e.add(e.multiply(m, p), h),
                y = e.divide(f, d)
  ...
  P = (function() {
    function t(t, e, n) {
      ...
      for (var i, s = [u], a = w(t.entries()); !(i = a()).done; ) {
        var c = i.value,
          p = c[1],
          l = s[c[0]]
...
var R = (function() {
  ...
  return (
    (e.minimumAmountOut = function(t) {
      if ((t.lessThan(a) && r(!1), this.tradeType === n.TradeType.EXACT_OUTPUT)) return this.outputAmount
      var e = new n.Fraction(c)
        .add(t)
        .invert()
    ...
    (e.maximumAmountIn = function(t) {
      if ((t.lessThan(a) && r(!1), this.tradeType === n.TradeType.EXACT_INPUT)) return this.inputAmount
      var e = new n.Fraction(c).add(t).multiply(this.inputAmount.quotient).quotient
      return n.CurrencyAmount.fromRawAmount(this.inputAmount.currency, e)
    }),
    (t.bestTradeExactIn = function(e, o, u, i, s, c, p) {
      var l = void 0 === i ? {} : i,
        m = l.maxNumResults,
        h = void 0 === m ? 3 : m,
        f = l.maxHops,
      ...
      for (var y = c.wrapped, v = u.wrapped, T = 0; T < e.length; T++) {
        ...
        if (
          ...
          !A.reserve0.equalTo(a) &&
          !A.reserve1.equalTo(a)
        ) {
          var q = void 0
          try {
          ...
          if (q.currency.equals(v))
            n.sortedInsert(p, new t(new P([].concat(s, [A]), o.currency, u), o, n.TradeType.EXACT_INPUT), h, _)
          else if (d > 1 && e.length > 1) {
            var k = e.slice(0, T).concat(e.slice(T + 1, e.length))
            t.bestTradeExactIn(k, o, u, { maxNumResults: h, maxHops: d - 1 }, [].concat(s, [A]), q, p)
          }
        }
      }
      return p
    ...
    (t.bestTradeExactOut = function(e, o, u, i, s, c, p) {
      var l = void 0 === i ? {} : i,
        m = l.maxNumResults,
        h = void 0 === m ? 3 : m,
        f = l.maxHops,
      ...
      for (var y = c.wrapped, v = o.wrapped, T = 0; T < e.length; T++) {
        ...
        if (
          ...
          if (q.currency.equals(v))
            n.sortedInsert(p, new t(new P([A].concat(s), o, u.currency), u, n.TradeType.EXACT_OUTPUT), h, _)
          else if (d > 1 && e.length > 1) {
            var k = e.slice(0, T).concat(e.slice(T + 1, e.length))
            t.bestTradeExactOut(k, o, u, { maxNumResults: h, maxHops: d - 1 }, [A].concat(s), q, p)
          }
        }
      }
      return p
  ...
  return (
    (t.swapCallParameters = function(t, e) {
      ...
      var i,
        ...
        p = F(t.maximumAmountIn(e.allowedSlippage)),
        l = F(t.minimumAmountOut(e.allowedSlippage)),
      ...
      switch (t.tradeType) {
        case n.TradeType.EXACT_INPUT:
          o
            ? ((i = f ? 'swapExactETHForTokensSupportingFeeOnTransferTokens' : 'swapExactETHForTokens'),
              (s = [l, m, c, h]),
              (a = p))
            : u
            ? ((i = f ? 'swapExactTokensForETHSupportingFeeOnTransferTokens' : 'swapExactTokensForETH'),
              (s = [p, l, m, c, h]),
              (a = '0x0'))
            : ((i = f ? 'swapExactTokensForTokensSupportingFeeOnTransferTokens' : 'swapExactTokensForTokens'),
              (s = [p, l, m, c, h]),
              (a = '0x0'))
          break
        case n.TradeType.EXACT_OUTPUT:
          f && r(!1),
            o
              ? ((i = 'swapETHForExactTokens'), (s = [l, m, c, h]), (a = p))
              : u
              ? ((i = 'swapTokensForExactETH'), (s = [l, p, m, c, h]), (a = '0x0'))
              : ((i = 'swapTokensForExactTokens'), (s = [l, p, m, c, h]), (a = '0x0'))
      }
...
;(exports.FACTORY_ADDRESS = '0x3Dc30d756A1382BF454dD6bDb48b7225CA214bB3'),
  (exports.INIT_CODE_HASH = i),
  (exports.InsufficientInputAmountError = I),
  (exports.InsufficientReservesError = x),
  (exports.MINIMUM_LIQUIDITY = s),
  (exports.Pair = E),
  (exports.Route = P),
  (exports.Router = S),
  (exports.Trade = R),
