...
function q(t) {
  ...
  return (q = function(t) {
    ...
    function n() {
      return T(t, arguments, y(this).constructor)
    }
    return (
...
var x = 'setPrototypeOf' in Object,
  I = (function(t) {
    function e() {
      ...
      return (
        ...
        x && Object.setPrototypeOf(k(n), (this instanceof e ? this.constructor : void 0).prototype),
        n
      )
    }
    return d(e, t), e
  ...
  E = (function() {
    ...
    t.getAddress = function(t, e) {
      return O({ factoryAddress: '0x68ACB0a83AfBa44BA75F800Bf069b6ED6aAac16D', tokenA: t, tokenB: e })
    }
    var o = t.prototype
    return (
      ...
      (o.getOutputAmount = function(o) {
        ...
        var u = this.reserveOf(o.currency),
          ...
          f = n.CurrencyAmount.fromRawAmount(o.currency.equals(this.token0) ? this.token1 : this.token0, e.divide(c, p))
        if (e.equal(f.quotient, a)) throw new b()
        return [f, new t(u.add(o), i.subtract(f))]
      }),
      (o.getInputAmount = function(o) {
        ...
        return [f, new t(i.add(f), u.subtract(o))]
      }),
      (o.getLiquidityMinted = function(t, o, u) {
        ...
        if (!e.greaterThan(i, a)) throw new b()
        ...
        if (
          ...
          if (e.equal(l, a)) c = o
            ...
            var m = n.sqrt(e.multiply(this.reserve0.quotient, this.reserve1.quotient)),
              f = n.sqrt(l)
            if (e.greaterThan(m, f)) {
              var h = e.multiply(o.quotient, e.subtract(m, f)),
                d = e.add(e.multiply(m, p), f),
                y = e.divide(h, d)
    ...
    (t.bestTradeExactIn = function(e, o, u, i, s, c, p) {
      ...
      for (var y = c.wrapped, v = u.wrapped, A = 0; A < e.length; A++) {
        ...
        if (
          ...
          !T.reserve0.equalTo(a) &&
          !T.reserve1.equalTo(a)
        ) {
          var q = void 0
          try {
          ...
          if (q.currency.equals(v))
            n.sortedInsert(p, new t(new P([].concat(s, [T]), o.currency, u), o, n.TradeType.EXACT_INPUT), f, _)
          else if (d > 1 && e.length > 1) {
            var k = e.slice(0, A).concat(e.slice(A + 1, e.length))
            t.bestTradeExactIn(k, o, u, { maxNumResults: f, maxHops: d - 1 }, [].concat(s, [T]), q, p)
          }
        }
      }
      return p
    ...
    (t.bestTradeExactOut = function(e, o, u, i, s, c, p) {
      ...
      for (var y = c.wrapped, v = o.wrapped, A = 0; A < e.length; A++) {
        ...
        if (
          ...
          if (q.currency.equals(v))
            n.sortedInsert(p, new t(new P([T].concat(s), o, u.currency), u, n.TradeType.EXACT_OUTPUT), f, _)
          else if (d > 1 && e.length > 1) {
            var k = e.slice(0, A).concat(e.slice(A + 1, e.length))
            t.bestTradeExactOut(k, o, u, { maxNumResults: f, maxHops: d - 1 }, [T].concat(s), q, p)
          }
        }
      }
      return p
    ...
    (t.swapCallParameters = function(t, e) {
      ...
      switch (t.tradeType) {
        ...
        case n.TradeType.EXACT_OUTPUT:
          h && r(!1),
            o
              ? ((i = 'swapETHForExactTokens'), (s = [l, m, c, f]), (a = p))
              : u
              ? ((i = 'swapTokensForExactETH'), (s = [l, p, m, c, f]), (a = '0x0'))
              : ((i = 'swapTokensForExactTokens'), (s = [l, p, m, c, f]), (a = '0x0'))
      }
...
;(exports.FACTORY_ADDRESS = '0x68ACB0a83AfBa44BA75F800Bf069b6ED6aAac16D'),
  (exports.INIT_CODE_HASH = i),
  (exports.InsufficientInputAmountError = b),
