...
var computePairAddress = function computePairAddress(_ref) {
  ...
  return getCreate2Address(factoryAddress, keccak256(['bytes'], [pack(['address', 'address'], [token0.address, token1.address])]), (_INIT_CODE_HASHES$tok = INIT_CODE_HASHES[tokenA.chainId]) != null ? _INIT_CODE_HASHES$tok : INIT_CODE_HASH);
};
var Pair = /*#__PURE__*/function () {
  function Pair(currencyAmountA, tokenAmountB) {
    ...
    this.liquidityToken = new Token(tokenAmounts[0].currency.chainId, Pair.getAddress(tokenAmounts[0].currency, tokenAmounts[1].currency), 18, 'CLP', 'Cronus LP');
